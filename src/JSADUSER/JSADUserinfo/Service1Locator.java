...
public class Service1Locator extends org.apache.axis.client.Service implements JSADUSER.JSADUserinfo.Service1 {
    ...
    private java.lang.String Service1Soap_address = "http://192.168.1.27/JSADUSER/JSADUserinfo.asmx";
    ...
    public JSADUSER.JSADUserinfo.Service1Soap getService1Soap() throws javax.xml.rpc.ServiceException {
    ...
    public JSADUSER.JSADUserinfo.Service1Soap getService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            JSADUSER.JSADUserinfo.Service1SoapStub _stub = new JSADUSER.JSADUserinfo.Service1SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (JSADUSER.JSADUserinfo.Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                JSADUSER.JSADUserinfo.Service1SoapStub _stub = new JSADUSER.JSADUserinfo.Service1SoapStub(new java.net.URL(Service1Soap_address), this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://192.168.1.27/JSADUSER/JSADUserinfo", "Service1");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://192.168.1.27/JSADUSER/JSADUserinfo", "Service1Soap"));
        }
