package anyfive.ipims.office.common.abstractinfo.dao;
...
public class AbstractInfoDao extends NAbstractServletDao
{
    ...
    public String retrieveAbstractMstDiv(AjaxRequest xReq) throws NException
    {
        ...
        dao.setQuery("/ipims/office/common/abstractinfo/abstractinfo", "/retrieveAbstractMstDiv");
        dao.bind(xReq);
    ...
    public NSingleData retrieveAbstractInfo(String mstDiv, AjaxRequest xReq) throws NException
    {
        ...
        dao.setQuery("/ipims/office/common/abstractinfo/abstractinfo", "/retrieveAbstractInfo" + mstDiv);
        dao.bind(xReq);
