...
import anyfive.ipims.patent.common.approvaladdon.dao.ApprovalG01Dao;
import anyfive.ipims.patent.common.approvaladdon.util.ApprovalAbstractBiz;

public class ApprovalG01Biz extends NAbstractServletBiz implements ApprovalAbstractBiz
{
    public ApprovalG01Biz(NServiceResource nsr)
    {
        super(nsr);
    }
    ...
    {
        ApprovalG01Dao dao = new ApprovalG01Dao(this.nsr);
        dao.updateProgramExamResult(apprKey);

        /* 의뢰일 업데이트*/
        dao.updateProgramPatTeamReqDate(apprKey);
    }
}
