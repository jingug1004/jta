...
import anyfive.ipims.patent.common.approvaladdon.dao.ApprovalP03Dao;
...
public class ApprovalP03Biz extends NAbstractServletBiz implements ApprovalAbstractBiz
{
    public ApprovalP03Biz(NServiceResource nsr)
    {
        super(nsr);
    }
    ...
    {
        ApprovalP03Dao dao = new ApprovalP03Dao(this.nsr);
        ...
        for (int i = 0; i < olCountryList.getRowSize(); i++) {
            ...
            refNo = dao.retrieveNewMasterRefNo(apprKey, countryCode);

            // 특허마스터 생성
            dao.createPatentMaster(apprKey, refId, refNo, countryCode);
