...
import anyfive.ipims.patent.common.approvaladdon.dao.ApprovalT03Dao;
...
public class ApprovalT03Biz extends NAbstractServletBiz implements ApprovalAbstractBiz
{
    public ApprovalT03Biz(NServiceResource nsr)
    {
        super(nsr);
    }
    ...
    {
        ApprovalT03Dao dao = new ApprovalT03Dao(this.nsr);
        ...
        for (int i = 0; i < olCountryList.getRowSize(); i++) {
            ...
            // 상표마스터 생성
            dao.createTMarkMaster(apprKey, refId, countryCode);
