...
import anyfive.ipims.patent.common.approvaladdon.dao.ApprovalE01Dao;
import anyfive.ipims.patent.common.approvaladdon.util.ApprovalAbstractBiz;

public class ApprovalE01Biz extends NAbstractServletBiz implements ApprovalAbstractBiz
{
    public ApprovalE01Biz(NServiceResource nsr)
    {
        super(nsr);
    }
    ...
    {
        ApprovalE01Dao dao = new ApprovalE01Dao(this.nsr);
