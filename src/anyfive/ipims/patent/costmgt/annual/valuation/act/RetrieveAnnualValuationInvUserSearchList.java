 ...
 * 발명부서 평가자 목록 검색
 */
public class RetrieveAnnualValuationInvUserSearchList implements NAbstractServletAct
{
    public void execute(HttpServletRequest req, HttpServletResponse res, NServiceResource nsr) throws Exception
    {
        ...
        NSingleData result = biz.retrieveAnnualValuationInvUserSearchList(xReq);
        nsr.closeConnection();
