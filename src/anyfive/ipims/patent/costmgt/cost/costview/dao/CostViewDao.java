package anyfive.ipims.patent.costmgt.cost.costview.dao;
...
public class CostViewDao extends NAbstractServletDao
{
    ...
    public NSingleData retrieveCostViewList(AjaxRequest xReq) throws NException
    {
        ...
        dao.setQuery("/ipims/patent/costmgt/cost/costview", "/retrieveCostViewList");
        dao.bind(xReq);
    ...
    public NSingleData RetrieveCostViewInputList(AjaxRequest xReq) throws NException
    {
        ...
        dao.setQuery("/ipims/patent/costmgt/cost/costview", "/retrieveCostViewInputList");
        dao.bind(xReq);
