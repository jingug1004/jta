package anyfive.ipims.patent.costmgt.cost.intcost.dao;
...
public class IntCostDao extends NAbstractServletDao
{
    ...
    public NSingleData retrieveIntCostList(AjaxRequest xReq) throws NException
    {
        ...
        dao.setQuery("/ipims/patent/costmgt/cost/intcost", "/retrieveIntCostList");
        dao.bind(xReq);
    ...
    public int createIntCostRequest(AjaxRequest xReq) throws NException
    {
        ...
        dao.setQuery("/ipims/patent/costmgt/cost/intcost", "/createIntCostRequest");
        dao.bind(xReq);
    ...
    public int[] updateIntCostListReqId(AjaxRequest xReq) throws NException
    {
        ...
        dao.setQuery("/ipims/patent/costmgt/cost/intcost", "/updateIntCostListReqId");
        dao.bind(xReq);
