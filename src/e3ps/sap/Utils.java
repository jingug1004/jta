...
public class Utils
{
    ...
    {
        for (int i = 0; i < strings.length; ++i)
            if (string.equalsIgnoreCase(strings[i])) return i;
        return -1;
    }
    ...
    public static boolean equalsStrings(String[] strings1, String[] strings2)
    {
        ...
        for (int i = 0; i < strings1.length; ++i)
            if (!strings1[i].equals(strings2[i])) return false;
        return true;
    }
    ...
    public static boolean instanceOf(Object o, Class cl)
    {
        ...
        if (!cl.isInterface()) {
            ...
            for (int i = 0; i < ifs.length; ++i)
                if (instanceOf(o, ifs[i])) return true;
        }
    ...
    public static String urlDecoder(String encoded)
    {
        ...
        for (int i = 0; i < len; ++i) {
            if (encoded.charAt(i) == '%' && i + 2 < len) {
                ...
                i += 2;
            } else if (encoded.charAt(i) == '+') decoded.append(' ');
