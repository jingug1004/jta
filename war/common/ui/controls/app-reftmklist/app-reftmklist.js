any.control("app-reftmklist").inherit("any-dsgrid", function initialize(control, controlName)
{
    ...
    this.addColumn({width : 200, align : "left"  , name : "KO_APP_TITLE"        , label : any.message("lbl.TMARK_TITLE", "상표명칭")});
    this.addColumn({width : 100, align : "center", name : "COUNTRY_NAME"        , label : any.message("lbl.COUNTRY_NAME", "국가")});
    this.addColumn({width : 100, align : "center", name : "INV_MGT_PERSON_NAME" , label : any.message("lbl.REQ_PERSON_NAME", "의뢰자")});
