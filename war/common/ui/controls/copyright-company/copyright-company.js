any.control("copyright-company").inherit("any-dsgrid", function initialize(control, controlName)
{
    ...
    this.addColumn({ width:300, align:"center", name:"QUOTA_RATIO" , label:any.message("lbl.QUOTA_RATIO", "지분율(%)"), control:"any-number", controlattr:{ min:0, max:100 }, edit:true, require:true });
