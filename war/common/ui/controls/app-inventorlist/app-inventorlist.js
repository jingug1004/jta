any.control("app-inventorlist").inherit("any-dsgrid", function initialize(control, controlName)
{
    this.addColumn({ width:35 , align:"center", name:"MAIN_INVENTOR_YN" , label:any.message("lbl.MAIN_INVENTOR_YN","주"), control:"radio", edit:true });
    ...
    this.addColumn({ width:80 , align:"right" , name:"QUOTA_RATIO"      , label:any.message("lbl.QUOTA_RATIO","지분율"), control:"any-number", controlattr:{ min:0, max:100 }, edit:true });
...
.define(function behavior(control, controlName)
{
    ...
    (function main() {
        ...
        control.addButton(any.message("app.inventorlist.btn.quotaratio.autoCalc", "지분율 자동계산"), resetPriShare);
