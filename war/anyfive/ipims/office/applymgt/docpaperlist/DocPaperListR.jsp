...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.office.applymgt.docpaperlist.act.RetrieveDocPaperList.do";
    ...
    ldr.addParam("OFFICE_JOB_MAN" , OFFICE_JOB_MAN.value);
        ...
        <TD>
            <TABLE border="0" cellspacing="1" cellpadding="2" class="main" onEnter="javascript:fnRetrieve();">
                ...
                <TR>
                    <TD>사무소담당자</TD>
                    <TD>
                        <ANY:SELECT id="OFFICE_JOB_MAN" codeData="/common/officeJobMan,<%= app.userInfo.getOfficeCode() %>" firstName="all" />
                    </TD>
                    <TD>건담당자</TD>
                    <TD>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_docPaperList" pagingType="1"><COMMENT>
                ...
                addColumn({ width:80 , align:"center", type:"string", sort:true , id:"OFFICE_JOB_MAN_NAME"  , name:"사무소담당자" });
                ...
                addColumn({ width:100, align:"left"  , type:"string", sort:true , id:"GRP_ID"          , name:"진행상태" , hide:true});
                useConfig = true;
