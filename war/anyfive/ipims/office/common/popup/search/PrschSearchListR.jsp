...
function fnSearch()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.office.common.popup.search.act.RetrievePrschSearchList.do";
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_prschList" pagingType="1"><COMMENT>
                ...
                addColumn({ width:120, align:"center", type:"string", sort:true , id:"PRSCH_TYPE_NAME"  , name:"내/외부조사" });
