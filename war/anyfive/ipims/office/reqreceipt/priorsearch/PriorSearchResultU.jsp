...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.office.reqreceipt.priorsearch.act.UpdatePriorSearchResult.do";
    prx.addParam("PRSCH_ID", parent.PRSCH_ID);
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.replace("PriorSearchResultRD.jsp");
    }
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        ...
        <TD colspan="3">
            <TEXTAREA id="PRSCH_RESULT" rows="5"></TEXTAREA>
        </TD>
    </TR>
    <TR>
