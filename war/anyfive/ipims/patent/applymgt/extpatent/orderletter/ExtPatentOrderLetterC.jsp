...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.extpatent.orderletter.act.RetrieveExtPatentOrderLetterGroup.do";
    prx.addParam("GRP_ID", parent.GRP_ID);
    prx.checkData = ds_groupInfo;
...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.extpatent.orderletter.act.CreateExtPatentOrderLetter.do";
    prx.addParam("GRP_ID", parent.GRP_ID);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>대표PJT</TD>
        <TD colspan="3"><ANY:PJT id="any_projectList" mode="R"/></TD>
    </TR>
    <TR>
        <TD>공동출원여부</TD>
...
<DIV class="button_area">
    ...
    <BUTTON auto="list" list="ExtPatentGroupListR.jsp"></BUTTON>
</DIV>
