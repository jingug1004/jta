...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.extpatent.condiv.act.RetrieveExtPatentConDiv.do";
...
function fnModify()
{
    window.location.href = "ExtPatentConDivU.jsp";
}
</SCRIPT>
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>출원형태</TD>
        <TD><ANY:SPAN id="DIVISION_TYPE_NAME"></ANY:SPAN></TD>
        <TD>계속/분할 작성일</TD>
        <TD><ANY:SPAN id="OL_CRE_DATE" format="date" /></TD>
    </TR>
    <TR>
        <TD>첨부파일</TD>
        <TD colspan="3">
    ...
    <TR>
        <TD>비고</TD>
        <TD colspan="3"><ANY:SPAN id="EXAM_OPINION"></ANY:SPAN></TD>
    </TR>
</TABLE>
...
<ANY:APPROVAL id="any_approval" code="P04"><COMMENT>
