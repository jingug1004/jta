...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.extpatent.condiv.act.UpdateExtPatentConDiv.do";
    prx.addParam("OL_ID", parent.OL_ID);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        ...
        <TD><ANY:SELECT id="DIVISION_TYPE" codeData="{OL_DIVISION_TYPE}" firstName="sel" /></TD>
        <TD>계속/분할 작성일</TD>
