...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.extpatent.eppct.act.RetrieveExtPatentEpPctPrior.do";
...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.extpatent.eppct.act.CreateExtPatentEpPct.do";
    prx.addParam("DIVISION_PRIOR_REF_ID", parent.REF_ID);
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.replace("ExtPatentEpPctRD.jsp");
    }
