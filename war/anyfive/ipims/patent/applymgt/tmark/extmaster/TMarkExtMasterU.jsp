...
function fnSave()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.extmaster.act.UpdateTMarkExtMaster.do";
    prx.addParam("REF_ID", parent.REF_ID);
    ...
    <TR>
        ...
        <TD>
            <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
                <TR>
                    <TD width="100%">
                        <INPUT type="text" id="111REG_NO" maxByte="30">
                    </TD>
                    <TD>&nbsp;</TD>
                    <TD>
                        <ANY:DATE id="R111EG_DATE" />
                    </TD>
                </TR>
            </TABLE>
        </TD>
        <TD>갱신횟수</TD>
        <TD><INPUT id="11EXT_OFFICE_REF_NO" type="text" maxByte="30"></TD>
    </TR>
    <TR>
        <TD>진행여부/포기일</TD>
        <TD colspan="3">
