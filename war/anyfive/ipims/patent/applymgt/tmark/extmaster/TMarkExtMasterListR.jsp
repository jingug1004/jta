...
function fnRetrieve()
{
    var ldr = gr_TMarkExtMasterList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.extmaster.act.RetrieveTMarkExtMasterList.do";
...
function fnWrite()
{
    ...
    win.path = "TMarkExtMasterC.asp";

    win.onReload = function()
    {
        gr_TMarkExtMasterList.loader.reload();
    }
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
        ...
        <TD>
            <TABLE border="0" cellspacing="1" cellpadding="2" class="main" onEnter="javascript:fnRetrieve();">
                ...
                <TR>
                    ...
                    <TD colspan="3">
                        <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
                            <TR>
                                <TD>
                                    <ANY:SELECT id="SR_NO_GUBUN" codeData="/applymgt/tMarkExtMasterOptSelNo" style="width:110px; margin-right:3px;"/>
                                </TD>
                                <TD width="100%">
                ...
                <TR>
                    <TD>진행상태</TD>
                    <TD>
                        <ANY:SELECT id="SR_STATUS" codeData="/applymgt/masterStatus,40,EXT" firstName="all" />
                    </TD>
                    <TD>상표명</TD>
                    <TD>
                        <INPUT type="text" id="SR_TITLE" style="width:100%;">
                    </TD>
                    <TD>건담당자</TD>
                    <TD>
                        <ANY:SELECT id="SR_JOB_MAN" codeData="/common/jobMan,TRA" value="<%= app.userInfo.getUserId() %>" firstName="all" />
                    </TD>
                </TR>
                <TR>
                    <TD>출원사무소</TD>
                    ...
                    <TD>검색일자</TD>
                    <TD colspan="3">
                        <ANY:SELECT id="SR_DATE_CODE" codeData="/applymgt/tMarkMasterSearchDateType" firstName="none" style="width:70px; margin-right:3px;"/>
                        <ANY:DATE id="SR_SDATE" value="" disabled />&nbsp;~
                        <ANY:DATE id="SR_EDATE" value="" disabled />
                    </TD>
                </TR>
            </TABLE>
        </TD>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_TMarkExtMasterList" pagingType="1"><COMMENT>
