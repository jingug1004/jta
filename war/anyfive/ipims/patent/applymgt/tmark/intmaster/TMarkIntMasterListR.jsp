...
function fnRetrieve()
{
    var ldr = gr_TMarkIntMasterList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.intmaster.act.RetrieveTMarkIntMasterList.do";
...
function fnWrite()
{
    ...
    win.path = "TMarkIntMasterC.jsp";

    win.onReload = function()
    {
        gr_TMarkIntMasterList.loader.reload();
    }
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
        ...
        <TD>
            <TABLE border="0" cellspacing="1" cellpadding="2" class="main" onEnter="javascript:fnRetrieve();">
                ...
                <TR>
                    ...
                    <TD>
                        <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
                            <TR>
                                <TD>
                                    <ANY:SELECT id="SR_NO_GUBUN" codeData="/applymgt/tMarkMasterSearchType" style="width:105px; margin-right:3px;" />
                                </TD>
                                <TD width="100%">
                ...
                <TR>
                    <TD>검색일자</TD>
                    <TD noWrap>
                        <ANY:SELECT id="SR_DATE_CODE" codeData="/applymgt/tMarkMasterSearchDateType" firstName="none" style="width:105px; margin-right:3px;"/>
                    ...
                    <TD>진행상태</TD>
                    <TD>
                        <ANY:SELECT id="SR_STATUS" codeData="/applymgt/masterStatus,40,INT" firstName="all" />
                    </TD>
                </TR>
            </TABLE>
        </TD>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_TMarkIntMasterList" pagingType="1"><COMMENT>
