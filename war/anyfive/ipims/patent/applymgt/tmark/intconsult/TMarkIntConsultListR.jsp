...
function fnRetrieve()
{
    var ldr = gr_inTradeMarkConsultList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.intconsult.act.RetrieveTMarkIntConsultList.do";
...
function fnDetail(gr, fg, row, colId)
{
    ...
    if (gr.value(row, "JOB_MAN") == "<%= app.userInfo.getUserId() %>" && gr.value(row, "EXAM_RESULT") == "") {
        win.path = "TMarkIntConsultU.jsp";
    } else {
        win.path = "TMarkIntConsultRD.jsp";
    }
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
        ...
        <TD>
            <TABLE border="0" cellspacing="1" cellpadding="2" class="main" onEnter="javascript:fnRetrieve();">
                ...
                <TR>
                    ...
                    <TD>진행상태</TD>
                    <TD>
                        <ANY:SELECT id="SR_STATUS" codeData="/common/bizStepStatus,<%= WorkProcessConst.Step.INT_TMARK_CONSULT %>" firstName="all" />
                    </TD>
                </TR>
                <TR>
                    <TD>검색일자</TD>
                    <TD noWrap>
                        <ANY:SELECT id="SR_DATE_CODE" codeData="/applymgt/tMarkIntConsultListDateType" firstName="none" style="width:105px; margin-right:3px;"/>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_inTradeMarkConsultList" pagingType="1"><COMMENT>
