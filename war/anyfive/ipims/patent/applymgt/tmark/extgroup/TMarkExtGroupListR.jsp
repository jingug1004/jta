...
function fnRetrieve()
{
    var ldr = gr_ExtTMarkGroupList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.extgroup.act.RetrieveTMarkExtGroupList.do";
...
function fnWrite()
{
    ...
    win.path = "TMarkExtGroupC.jsp";

    win.onReload = function()
    {
        gr_ExtTMarkGroupList.loader.reload();
    }
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
                ...
                <TR>
                    ...
                    <TD>
                        <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
                            <TR>
                                <TD>
                                    <ANY:SELECT id="NO_GUBUN" codeData="/applymgt/tMarkExtOptSelNo" style="width:120px; margin-right:3px" />
                                </TD>
                                <TD width="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_ExtTMarkGroupList" pagingType="1"><COMMENT>
