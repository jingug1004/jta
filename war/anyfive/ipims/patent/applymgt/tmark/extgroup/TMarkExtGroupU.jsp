...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.extgroup.act.UpdateTMarkExtGroup.do";
    prx.addParam("GRP_ID", parent.GRP_ID);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>국내 REF-NO</TD>
        <TD colspan="3">
            <ANY:REFNO id="any_groupRefNoList" mode="U" rightDiv="40" inoutDiv="INT" multiCheck="false" />
        </TD>
    </TR>
    <TR>
