...
function fnRetrieve()
{
    var ldr = gr_tMarkReceiptList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.intreceipt.act.RetrieveTMarkIntReceiptList.do";
...
function fnDetail(gr, fg, row, colId)
{
    ...
    win.path = "TMarkIntReceiptRU.jsp";
...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.intreceipt.act.UpdateTMarkIntReceiptJobManList.do";
...
<% app.writeBodyHeader(); %>
 ...
 <TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_tMarkReceiptList" pagingType="0"><COMMENT>
