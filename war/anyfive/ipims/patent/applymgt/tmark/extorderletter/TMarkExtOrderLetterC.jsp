...
function fnRetrieve()
{
      ...
      prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.extorderletter.act.RetrieveTMarkExtOrderLetterGroup.do";
...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.extorderletter.act.CreateTMarkExtOrderLetter.do";
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.replace("TMarkExtOrderLetterRD.jsp");
    }
...
<TABLE border="0" cellspacing="1" cellpadding="2" width=100% class="main">
    ...
    <TR>
        <TD>발명자</TD>
        <TD colspan="3"><ANY:INV id="any_inventorList" mode="C"/></TD>
    </TR>
    <TR>
        <TD>공동권리여부</TD>
    ...
    <TR>
        ...
        <TD colspan="3">
            <ANY:OLCOUNTRY id="any_olCountryList" mode="U"><COMMENT>
                grpId = parent.GRP_ID;
