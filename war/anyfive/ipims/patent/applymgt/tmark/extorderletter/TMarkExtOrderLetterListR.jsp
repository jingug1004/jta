...
function fnRetrieve()
{
    var ldr = gr_tMarkOrderLetterList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.tmark.extorderletter.act.RetrieveTMarkExtOrderLetterList.do";
...
function fnDetail(gr, fg, row, colId)
{
    ...
    win.path = "TMarkExtOrderLetterRD.jsp";
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
        ...
        <TD>
            <TABLE border="0" cellspacing="1" cellpadding="2" class="main" onEnter="javascript:fnRetrieve();">
                ...
                <TR>
                    ...
                    <TD>진행상태</TD>
                    <TD>
                        <ANY:SELECT id="STATUS" codeData="/common/bizStepStatus,<%= WorkProcessConst.Step.EXT_TMARK_NEW_OL %>" firstName="all" />
                    </TD>
                </TR>
                <TR>
                    <TD>건담당자</TD>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_tMarkOrderLetterList" pagingType="1"><COMMENT>
                addColumn({ width:100, align:"left"  , type:"string", sort:true , id:"GRP_NO"               , name:"해외출원품의번호" });
                addColumn({ width:100, align:"left"  , type:"string", sort:true , id:"KR_APP_NO"            , name:"국내출원번호" });
                addColumn({ width:90 , align:"left"  , type:"string", sort:true , id:"COUNTRY_NAME"         , name:"출원국가" });
