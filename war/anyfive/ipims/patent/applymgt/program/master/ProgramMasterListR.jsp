...
function fnRetrieve()
{
    var ldr = gr_programMasterList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.program.master.act.RetrieveProgramMasterList.do";
...
function fnWrite()
{
    ...
    win.path = "ProgramMasterC.jsp";

    win.onReload = function()
    {
        gr_programMasterList.loader.reload();
    }
...
<% app.writeBodyHeader(); %>
 ...
 <TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_programMasterList" pagingType="1"><COMMENT>
