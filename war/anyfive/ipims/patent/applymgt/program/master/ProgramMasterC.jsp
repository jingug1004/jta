...
function fnSave(isFileUploaded)
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.program.master.act.CreateProgramMaster.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
   <COLGROUP>
    ...
    <TR>
        <TD>REF_NO</TD>
        <TD colspan="3" disabled>(<%= app.message.get("msg.com.autocreate") %>)</TD>
    </TR>
    <TR>
        <TD req="JOB_MAN">건 담당자</TD>
        <TD><ANY:SELECT id="JOB_MAN" codeData="/common/jobManAll" firstName="sel" /></TD>
        <TD req="PATTEAM_RCPT_DATE">접수일</TD>
        <TD><ANY:DATE id="PATTEAM_RCPT_DATE" value="<%= NDateUtil.getSysDate() %>" /></TD>
    </TR>
    <TR>
    ...
    <TR>
        ...
        <TD colspan="3"><ANY:INV id="any_inventorList" mode="C1"/></TD>
    </TR>
    <TR>
        <TD>프로그램내용</TD>
        <TD colspan="3">
