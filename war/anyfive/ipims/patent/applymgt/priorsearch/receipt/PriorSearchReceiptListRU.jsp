...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.priorsearch.receipt.act.RetrievePriorSearchReceiptList.do";
...
function fnSave()
{
    ...
    for (var r = gr.fg.FixedRows; r < gr.fg.Rows; r++) {
        ...
        ds.addRow();
        ds.value(ds.rowCount - 1, "PRSCH_ID") = gr.value(r, "PRSCH_ID");
    }
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.priorsearch.receipt.act.UpdatePriorSearchReceiptJobManList.do";
...
function fnDetail(gr, fg, row, colId)
{
    ...
    win.path = "PriorSearchReceiptRU.jsp";
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_examReceiptList" pagingType="0"><COMMENT>
                ...
                addColumn({ width:200, align:"left"  , type:"string", sort:true , id:"PRSCH_SUBJECT"    , name:"조사제목" });
                addColumn({ width:130, align:"left"  , type:"string", sort:true , id:"PRSCH_DIV_NAME"   , name:"조사구분" });
                addColumn({ width:130, align:"left"  , type:"string", sort:true , id:"PRSCH_NO"         , name:"의뢰번호" });
                ...
                setFixedColumn("ROW_NUM", "PRSCH_SUBJECT");
