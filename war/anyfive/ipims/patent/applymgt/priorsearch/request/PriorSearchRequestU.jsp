...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.priorsearch.request.act.UpdatePriorSearchRequest.do";
    prx.addParam("PRSCH_ID", parent.PRSCH_ID);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>의뢰서관련<BR>첨부파일</TD>
        <TD colspan="3">
            <ANY:FILE id="any_attachFile" mode="U" policy="prior_search" />
        </TD>
    </TR>
    <TR>
        <TD>조사의뢰내역</TD>
