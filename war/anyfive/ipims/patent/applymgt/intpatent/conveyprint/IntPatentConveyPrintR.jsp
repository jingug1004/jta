...
// 발명자 목록 생성 top
function fnMakeInventorListTop(){
    var invTop = ds_conveyPrintInventorTop;
    var html = new Array();

    for (var i = 0; i < invTop.rowCount; i++) {
        div_inventorListTop.innerHTML = html.join("\n");
        html.push('<TABLE border="0" cellspacing="1" cellpadding="0" class="main" width="100%"> ');
        html.push('    <COLGROUP>                               ');
        html.push('        <COL width="15%">                            ');
        html.push('        <COL width="15%">                            ');
        html.push('        <COL width="70%">                            ');
        html.push('    </COLGROUP>                              ');
        html.push('    <TR>                                 ');
        html.push('        <TD class="conthead" rowspan="2">양수인</TD>                ');
        html.push('        <TD class="conthead">회사</TD>                     ');
        html.push('        <TD class="contdata" width="50%">' + invTop.value(i,"NAME") +'</TD>      ');
        html.push('    </TR>                                    ');
        html.push('    <TR>                                 ');
        html.push('        <TD class="conthead">주소</TD>                 ');
        html.push('        <TD class="contdata" width="50%">' + invTop.value(i,"ADDRESS")  + '</TD>     ');
        html.push('    </TR>                                    ');
        html.push('</TABLE>                                 ');
...
function fnMakeInventorList()
{
    ...
    for (var i = 0; i < inv.rowCount; i++) {
        html.push('    <TR>                                                                                      ');
        html.push('        <TD class="conthead" rowspan="5">양도인</TD>                                          ');
...
<DIV id="div_inventorListTop"></DIV>
