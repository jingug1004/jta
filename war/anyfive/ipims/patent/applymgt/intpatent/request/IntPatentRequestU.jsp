...
function fnSave(isWriteEnd, isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.intpatent.request.act.UpdateIntPatentRequest.do";
    prx.addParam("REF_ID", parent.REF_ID);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>인용REF</TD>
        <TD colspan="3">
            <ANY:REFNO id="any_referRefNoList" mode="U" rightDiv="10,20" />
        </TD>
    </TR>
    <TR>
