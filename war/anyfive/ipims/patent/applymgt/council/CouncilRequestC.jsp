...
function fnSave(isFileUploaded)
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.council.act.CreateCouncilRequest.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>첨부파일</TD>
        <TD colspan="3"><ANY:FILE id="any_attachFile" mode="C" policy="reviewreq" /></TD>
    </TR>
    <TR>
