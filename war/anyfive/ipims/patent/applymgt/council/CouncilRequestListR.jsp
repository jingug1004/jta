...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.council.act.RetrieveCouncilRequestListR.do";
            ...
            <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
                <TR>
                    ...
                    <TD align="right">
                        ...
                        <BUTTON text ="심의요청" onClick="javascript:fnCreate();"></BUTTON>
                    </TD>
                </TR>
            </TABLE>
        </TD>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_councilRequestListR" pagingType="1"><COMMENT>
                ...
                addColumn({ width:200, align:"left"   , type:"string" , sort:true  , id:"REQ_SUBJECT"   , name:"심의요청제목" });
                addColumn({ width:150, align:"center" , type:"date"   , sort:true  , id:"SE_DATE"       , name:"심의기간"  });
                addColumn({ width:90,  align:"left"   , type:"string" , sort:true  , id:"STATUS"        , name:"진행상태" });
