...
function fnModify()
{
    window.location.href = "DesignExtGroupU.jsp";
}

//신규OL작성
function fnOrderLetter()
{
    window.location.href = top.getRoot() + "/anyfive/ipims/patent/applymgt/design/extorderletter/DesignExtOrderLetterC.jsp";
}
