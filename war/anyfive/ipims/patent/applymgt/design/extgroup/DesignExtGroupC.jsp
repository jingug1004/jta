...
function fnRetrieveIntMaster(refId)
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.design.extgroup.act.RetrieveIntMaster.do";
    ...
    prx.onSuccess = function()
    {
        ...
        APP_REWARD_GIVETARGET_YN.value = ds_searchInfo.value(0, "APP_REWARD_GIVETARGET_YN");
        REG_REWARD_GIVETARGET_YN.value = ds_searchInfo.value(0, "REG_REWARD_GIVETARGET_YN");
    }
...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.design.extgroup.act.CreateDesignExtGroup.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>국내 REF-NO</TD>
        <TD colspan="3">
            <ANY:REFNO id="any_groupRefNoList" mode="C" rightDiv="30" inoutDiv="INT" multiCheck="false" />
        </TD>
    </TR>
    <TR>
    ...
    <TR>
        <TD>공동권리 여부</TD>
        <TD><ANY:RADIO id="CORGT_YN" codeData="{YES_NO}" value="0" reqTd="td_corgtMan" /></TD>
    ...
    <TR>
        <TD>비용분담여부</TD>
        <TD><ANY:RADIO id="COSTSHARE_YN" codeData="{COSTSHARE_YN}" value="0" reqTd="td_costshareRatio" /></TD>
    ...
    <TR>
        <TD>관련파일 첨부</TD>
        <TD colspan="3">
            <ANY:FILE id="any_attachFile" mode="C" policy="design_extgroup" />
        </TD>
    </TR>
    <TR>
        <TD>비고</TD>
