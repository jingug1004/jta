...
function fnRetrieve(bool)
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.design.extorderletter.act.RetrieveDesignExtOrderLetter.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        ...
        <TD>작성자(작성일)</TD>
        <TD><SPAN id="CRE_USER_NAME"></SPAN>(<ANY:SPAN id="CRE_DATE" format="date" />)
...
<DIV class="button_area">
    <BUTTON text="<%= app.message.get("btn.com.modify").toHTML() %>"
            onClick="javascript:fnModify();" id="btn_modify" display="none"></BUTTON>
    <BUTTON auto="line" id="btn_line" display="none"></BUTTON>
    <BUTTON auto="list"></BUTTON>
</DIV>

<ANY:APPROVAL id="any_approval" code="D03"><COMMENT>
