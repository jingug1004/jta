...
function fnSave(isFileUploaded)
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.design.extorderletter.act.UpdateDesignExtOrderLetter.do";
    prx.addParam("OL_ID", parent.OL_ID);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>첨부파일</TD>
        <TD colspan=3>
            <ANY:FILE id="any_attachFile" mode="U" policy="design_extol" />
        </TD>
    </TR>
</TABLE>
