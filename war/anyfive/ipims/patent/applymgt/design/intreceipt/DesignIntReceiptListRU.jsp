...
function fnRetrieve()
{
    var ldr = gr_designReceiptList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.design.intreceipt.act.RetrieveDesignIntReceiptList.do";
...
function fnDetail(gr, fg, row, colId)
{
    ...
    win.path = "DesignIntReceiptRU.jsp";
...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.applymgt.design.intreceipt.act.UpdateDesignIntReceiptJobManList.do";
...
<% app.writeBodyHeader(); %>
 ...
 <TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_designReceiptList" pagingType="0"><COMMENT>
                ...
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"PATTEAM_REQ_DATE" , name:"특허팀의뢰일" });
