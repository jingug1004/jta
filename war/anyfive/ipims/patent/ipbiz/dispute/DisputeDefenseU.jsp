...
function fnSave()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.ipbiz.dispute.act.UpdateDispute.do";
    prx.addParam("DISPUTE_ID", parent.DISPUTE_ID);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>분석자료 링크</TD>
        <TD colspan="3">
            <ANY:ANALY id="any_analyList" mode="U" />
        </TD>
    </TR>
    <TR>
        <TD req="OFFICE_CODE">사무소</TD>
        <TD><ANY:SELECT id="OFFICE_CODE" codeData="/common/intOfficeCode" /></TD>
        <TD>변리사</TD>
