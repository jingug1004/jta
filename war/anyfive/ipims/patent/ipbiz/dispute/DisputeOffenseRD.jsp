...
//사무소송부
function fnOfficeSend()
{
    if (!confirm("사무소송부 처리하시겠습니까?")) return;

    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.ipbiz.dispute.act.UpdateDisputeOfficeSend.do";
    prx.addParam("DISPUTE_ID", parent.DISPUTE_ID);
...
function fnModify()
{
    window.location.href = "DisputeOffenseU.jsp";
}
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        ...
        <TD>분쟁/소송성격</TD>
        <TD><ANY:SPAN id="DISPUTE_DIV_NAME"/></TD>
    </TR>
    <TR>
        <TD>심판관(판사)</TD>
        <TD><ANY:SPAN id="JUDGE_MAN" /></TD>
        <TD>심급구분</TD>
        <TD><ANY:SPAN id="INS_DER_GERICHTE_NAME" /></TD>
    </TR>
    <TR>
        <TD>최종처분일</TD>
    ...
    <TR>
        <TD>당사 대리인</TD>
        <TD><ANY:SPAN id="OFFICE_AGENT" /></TD>
        <TD>상대 대리인</TD>
        <TD><ANY:SPAN id="OTHER_AGENT" /></TD>
    </TR>
    <TR>
        <TD>관할 법원</TD>
        <TD><ANY:SPAN id="DEFAULTS" /></TD>
        <TD>상대 변리사</TD>
    ...
    <TR>
        <TD colspan="4" class="contdata">
            <ANY:OURINFO id="any_groupRefNoList" mode="R" />
        </TD>
    </TR>
    <TR>
