...
function fnSave(isFileUploaded)
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.ipbiz.history.act.CreateIpBizHistory.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        ...
        <TD colspan="3"><ANY:DATE id="HIST_DATE" value="<%= NDateUtil.getSysDate() %>" /></TD>
    </TR>
    <TR>
    ...
    <TR>
        <TD>파일</TD>
        <TD colspan="3">
            <ANY:FILE id="any_histFile" mode="C" policy="ipbiz_history" />
        </TD>
    </TR>
</TABLE>
