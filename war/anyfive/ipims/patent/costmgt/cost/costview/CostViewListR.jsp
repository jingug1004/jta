...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.cost.costview.act.RetrieveCostViewList.do";
...
function fnDetail(gr, fg, row, colId)
{
    ...
    win.path = top.getRoot() + "/anyfive/ipims/patent/costmgt/cost/costview/CostViewRD.jsp";
