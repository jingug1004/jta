...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.cost.intcost.act.RetrieveIntCostList.do";
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_intCostList" pagingType="0"><COMMENT>
                ...
                addColumn({ width:110, align:"left"  , type:"string", sort:true , id:"GRAND_NAME"       , name:"대분류" });
                addColumn({ width:90 , align:"left"  , type:"string", sort:true , id:"DETAIL_NAME"      , name:"상세분류" });
