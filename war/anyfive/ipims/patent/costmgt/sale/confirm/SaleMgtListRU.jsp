...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.sale.confirm.act.RetrieveSaleMgtList.do";
...
function fnConfirm()
{
    var gr = document.getElementById("gr_saleMgtList");
    var ds = document.getElementById("ds_saleMgtList");
    ...
    if (!confirm("매각 확정 처리하시겠습니까?")) return;

    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.sale.confirm.act.CreateSaleMgt.do";
    prx.addData(ds);
...
function fnCancelConfirm()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.sale.confirm.act.DeleteSaleMgt.do";
    prx.addData(ds);
...
function fnCreateConsult()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.sale.consult.act.CreateSaleMgtConsult.do";
    prx.addData(ds);
    ...
    prx.onSuccess = function()
    {
        ...
        var win = new any.viewer();
        win.path = top.getRoot() + "/anyfive/ipims/patent/costmgt/sale/consult/SaleMgtRD.jsp";
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_saleMgtList" pagingType="0"><COMMENT>
    ...
    <TR>
        <TD>
            <DIV class="button_area">
                <BUTTON text="매각확정" onClick="javascript:fnConfirm();" id="btn_confirm" display="none"></BUTTON>
                <BUTTON text="매각확정취소" onClick="javascript:fnCancelConfirm();" id="btn_cancelConfirm" display="none"></BUTTON>
