...
function fnModify()
{
    window.location.href = "SaleMgtU.jsp";
}
...
function fnDelete()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.sale.consult.act.DeleteSaleMgtConsult.do";
    prx.addParam("CONSULT_ID", parent.CONSULT_ID);
...
<ANY:GRID id="gr_saleMgtList" pagingType="0" style="height:200px; margin-top:5px;"><COMMENT>
...
<ANY:APPROVAL id="any_approval" code="C05"><COMMENT>
