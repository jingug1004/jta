...
function fnRetrieve()
{
    var ldr = gr_costByProjectList.loader;

    ldr.init();
    ldr.path =  top.getRoot() + "/anyfive.ipims.patent.costmgt.statistic.act.RetrieveCostByProjectList.do";
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_costByProjectList" pagingType="1"><COMMENT>
                addHeader([null,null, "국내건", "", "해외건", "", "합계" ]);

                addColumn({ width:100 , align:"left"  , type:"string" , sort:true , id:"PJT_CODE" , name:"프로젝트코드", hide:true });
