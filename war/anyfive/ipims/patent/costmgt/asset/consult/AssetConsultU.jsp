...
function fnSave()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.asset.consult.act.UpdateAssetConsult.do";
    prx.addParam("CONSULT_ID", parent.CONSULT_ID);
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.replace("AssetConsultRD.jsp");
    }
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_assetCostList" pagingType="0" minHeight="200px"><COMMENT>
