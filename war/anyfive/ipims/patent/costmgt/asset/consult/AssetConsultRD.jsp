...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.asset.consult.act.RetrieveAssetConsult.do";
...
{
    var ldr = gr_assetCostList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.asset.consult.act.RetrieveAssetConsultCostList.do";
...
function fnModify()
{
    window.location.href = "AssetConsultU.jsp";
}
...
function fnDelete()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.asset.consult.act.DeleteAssetConsult.do";
    prx.addParam("CONSULT_ID", parent.CONSULT_ID);
...
<ANY:GRID id="gr_assetCostList" pagingType="0" style="height:200px; margin-top:5px;"><COMMENT>
    ...
    addColumn({ width:100, align:"center", type:"date", sort:true , id:"APP_DATE"         , name:"출원일" });
...
<ANY:APPROVAL id="any_approval" code="C04"><COMMENT>
