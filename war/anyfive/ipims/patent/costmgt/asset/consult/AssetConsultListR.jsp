...
function fnRetrieve()
{
    var ldr = gr_assetConsultList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.asset.consult.act.RetrieveAssetConsultList.do";
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_assetConsultList" pagingType="1"><COMMENT>
