...
function fnRetrieve()
{
    var ldr = gr_rewardConsultList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.reward.consult.act.RetrieveRewardConsultList.do";
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_rewardConsultList" pagingType="1"><COMMENT>
