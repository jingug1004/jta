...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.slip.cost.act.RetrieveCostSlipList.do";
...
function fnCreateSlip()
{
    ...
    var gr = document.getElementById("gr_costSlipList");
    ...
    if (!confirm("출원 비용 전표를 작성하시겠습니까?")) return;

    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.slip.proc.act.CreateSlipProc.do";
    prx.addParam("SLIP_SUBJECT", "<%= NDateUtil.getFormatDate("yyyy")%>년 <%= NDateUtil.getFormatDate("MM")%>월 비용");
    prx.addParam("SLIP_KIND", "C");
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_costSlipList" pagingType="0"><COMMENT>
                ...
                addColumn({ width:130, align:"left"  , type:"string" , sort:true , id:"PJT_NAME"    , name:"프로젝트" });
