...
function fnRetrieveSlipProcCostList()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.slip.cost.act.RetrieveCostSlipDetailList.do";
...
function fnSave()
{
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.href = "CostSlipRD.jsp";
    }
...
function fnDetail()
{
    window.location.replace("CostSlipRD.jsp");
}
</SCRIPT>
</HEAD>
