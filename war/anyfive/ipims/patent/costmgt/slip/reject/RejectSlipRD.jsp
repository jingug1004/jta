...
function fnRetrieve()
{
    ...
    {
        cfShowObjects([ btn_line1, btn_confirm, btn_line2], ds_mainInfo.value(0, "FLAG2") == "" && ds_mainInfo.value(0, "COST_DATE") != "" && ds_mainInfo.value(0, "INVOICE_DATE") != "");

        if(ds_mainInfo.value(0, "FLAG2") == "I" || ds_mainInfo.value(0, "FLAG2") == "S" || ds_mainInfo.value(0, "FLAG2") == "A"){
...
function fnModify()
{
    window.location.href = "RejectSlipU.jsp";
}
