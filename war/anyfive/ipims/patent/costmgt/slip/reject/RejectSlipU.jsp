...
function fnRetrieveSlipProcCostList()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.slip.reject.act.RetrieveRejectSlipCostList.do";
...
function fnSave()
{
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.href = "RejectSlipRD.jsp";
    }
...
function fnDetail()
{
    window.location.replace("RejectSlipRD.jsp");
}
</SCRIPT>
</HEAD>
