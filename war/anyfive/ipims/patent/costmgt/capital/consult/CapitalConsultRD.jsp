...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.capital.consult.act.RetrieveCapitalMgtConsult.do";
...
{
    var ldr = gr_capitalList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.capital.consult.act.RetrieveCapitalMgtCostInput.do";
...
function fnModify()
{
    window.location.href = "CapitalConsultU.jsp";
}
...
function fnDelete()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.capital.consult.act.DeleteCapitalMgtConsult.do";
    prx.addParam("CONSULT_ID", parent.CONSULT_ID);
...
<ANY:GRID id="gr_capitalList" pagingType="0" style="height:200px; margin-top:5px;"><COMMENT>
...
<ANY:APPROVAL id="any_approval" code="C06"><COMMENT>
