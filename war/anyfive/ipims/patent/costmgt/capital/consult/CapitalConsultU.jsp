...
function fnSave()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.costmgt.capital.consult.act.UpdateCapitalMgtConsult.do";
    prx.addParam("CONSULT_ID", parent.CONSULT_ID);
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.replace("CapitalConsultRD.jsp");
    }
