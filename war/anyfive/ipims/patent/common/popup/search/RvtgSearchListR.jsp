...
function fnSearch()
{
    var ldr = gr_MgtIdList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.common.popup.search.act.RetrieveRvtgSearchList.do";
...
function fnConfirm()
{
    cfPopupSearchResult(parent, gr_MgtIdList);
}
</SCRIPT>
</HEAD>
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_MgtIdList" pagingType="1"><COMMENT>
