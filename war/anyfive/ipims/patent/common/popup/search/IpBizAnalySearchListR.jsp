...
function fnSearch()
{
    var ldr = gr_ipbizAnalyList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.common.popup.search.act.RetrieveIpBizAnalySearchList.do";
...
function fnConfirm()
{
    cfPopupSearchResult(parent, gr_ipbizAnalyList);
}
</SCRIPT>
</HEAD>
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_ipbizAnalyList" pagingType="1"><COMMENT>
                addColumn({ width:30 , align:"center", type:"check" , sort:false, id:"ROW_CHK"          , hide:true });
                addColumn({ width:110, align:"left"  , type:"string", sort:true , id:"MGT_NO"           , name:"관리번호" });
                addColumn({ width:70 , align:"center", type:"string", sort:true , id:"ANALY_DIV_NAME"   , name:"구분" });
                addColumn({ width:200, align:"left"  , type:"string", sort:true , id:"ANALY_NAME"       , name:"분석자료명" });
