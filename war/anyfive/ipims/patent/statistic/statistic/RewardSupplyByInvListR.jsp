...
function fnRetrieve()
{
    var ldr = gr_rewardSupplyByInvList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.statistic.act.RetrieveRewardSupplyByInvList.do";
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_rewardSupplyByInvList" pagingType="1"><COMMENT>
                addColumn({ width:120, align:"left"  , type:"string", sort:true , id:"REF_NO"            , name:"REF-NO" });
                addColumn({ width:80 , align:"center", type:"string", sort:true , id:"INOUT_DIV_NAME"    , name:"국내외" });
                ...
                addColumn({ width:70 , align:"center", type:"string", sort:true , id:"INV_GRADE"         , name:"등급" });
                addColumn({ width:100, align:"right" , type:"string", sort:true , id:"PRICE"             , name:"보상금" , format:"#,###" });
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"ACCOUNT_PROC_DATE" , name:"지급년도" });
                addColumn({ width:80 , align:"left"  , type:"string", sort:true , id:"APP_NO"            , name:"출원번호" });
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"APP_DATE"          , name:"지급년도" });
                addColumn({ width:80 , align:"left"  , type:"string", sort:true , id:"REG_NO"            , name:"등록번호" });
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"REG_DATE"          , name:"지급년도" });
                useConfig = true;
