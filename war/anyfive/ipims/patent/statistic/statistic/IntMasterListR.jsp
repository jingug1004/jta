...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.statistic.act.RetrieveIntMasterList.do";
                ...
                <TR>
                    ...
                    <TD>
                        <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
                            <TR>
                                <TD>
                                    <ANY:SELECT id="NO_GUBUN" codeData="/applymgt/inNewConsultNoGubun" value="REF_NO" style="width:80px; margin-right:3px;"/>
                                </TD>
                                <TD width="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_intMasterList" pagingType="1"><COMMENT>
                ...
                addColumn({ width:130, align:"left"  , type:"string", sort:true , id:"KO_APP_TITLE"         , name:"출원의명칭" });
                addColumn({ width:75 , align:"left"  , type:"string", sort:true , id:"REG_NO"               , name:"등록번호" });
                ...
                addColumn({ width:75 , align:"center", type:"string", sort:true , id:"EXT_APP_STATUS_NAME"  , name:"해외출원" });
                addColumn({ width:75 , align:"center", type:"string", sort:true , id:"EXAMREQ_YN_NAME"      , name:"심사청구" });
                addColumn({ width:75 , align:"center", type:"string", sort:true , id:"NDEP"                 , name:"청구항(독립/종속)" });
                ...
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"REWARD_GIVE_DATE"     , name:"보상급지급일" });
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"ABD_DATE"             , name:"포기일" });
                addColumn({ width:80 , align:"left"  , type:"string", sort:true , id:"STATUS_NAME"          , name:"진행상태" });
                useConfig = true;
