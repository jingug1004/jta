...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.statistic.act.RetrieveExtOAList.do";
        ...
        <TD>
            <TABLE border="0" cellspacing="1" cellpadding="2" class="main" onEnter="javascript:fnRetrieve();">
                ...
                <TR>
                    <TD>검색일</TD>
                    <TD colspan="3" noWrap>
                        <ANY:SELECT id="DATE_KIND" codeData="/applymgt/statisticExtOASearchDateKind" firstName="none" style="width:105px; margin-right:3px;"/>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_intOAList" pagingType="1"><COMMENT>
                ...
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"DATE02"               , name:"Response제출" });
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"DATE03"               , name:"의견안접수" });
                addColumn({ width:75 , align:"center", type:"date"  , sort:true , id:"DATE04"               , name:"Response제출지시" });
