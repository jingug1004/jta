...
function fnRetrieve()
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.statistic.act.RetrieveDeliveryApplyList.do";
        ...
        <TD>
            <TABLE border="0" cellspacing="1" cellpadding="2" class="main" onEnter="javascript:fnRetrieve();">
                ...
                <TR>
                    ...
                    <TD>검색일</TD>
                    <TD colspan="3" noWrap>
                        <ANY:SELECT id="DATE_GUBUN" codeData="/applymgt/deliveryApplyDateKind" firstName="none" style="width:120px; margin-right:3px;"/>
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_intMasterList" pagingType="1"><COMMENT>
                ...
                addColumn({ width:100, align:"center"  , type:"string" , sort:true , id:"JOB_MAN_TO_OFFICE", name:"건담당자지정일->사무소접수일" });
                addColumn({ width:100, align:"center"  , type:"string" , sort:true , id:"OFFICE_TO_DRAFT"  , name:"사무소접수->초안작성" });
                addColumn({ width:100, align:"center"  , type:"string" , sort:true , id:"DRAFT_TO_APPLY"   , name:"초안작성->출원" });
