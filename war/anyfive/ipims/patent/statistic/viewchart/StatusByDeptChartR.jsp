...
function fnRetrieve2()//아래 왼쪽에 뿌려질 그리드 호출
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.viewchart.act.RetrieveStatusByDeptChartForGrid.do";
...
function fnDetail(gr, fg, row, colId)//아래 오른쪽에 뿌려질 해당 그리드 리스트
{
    ...
    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.viewchart.act.RetrieveStatusByDeptChartDetail.do";
                ...
                <TR>
                    <TD width="35%">
                        <ANY:GRID id="gr_deptChartList" pagingType="0" width="30%"><COMMENT>
                            ...
                            addColumn({ width:100, align:"center", type:"string", sort:false, id:"COL1", name:"출원" });
