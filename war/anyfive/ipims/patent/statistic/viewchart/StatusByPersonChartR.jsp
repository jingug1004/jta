...
{
    var ldr = gr_personChartList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.viewchart.act.RetrieveStatusByPersonChartForGrid.do";
...
{
    var ldr = gr_personRightChartList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.viewchart.act.RetrieveStatusByPersonChartDetail.do";
    ...
    <TR>
        <TD>
            ...
            <TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="35%">
                <TR>
                    <TD width="35%">
                        <ANY:GRID id="gr_personChartList" pagingType="0" width="30%"><COMMENT>
                    ...
                    <TD width="1%"></TD>
                    <TD width="61%">
                        <ANY:GRID id="gr_personRightChartList" pagingType="0" width="60%"><COMMENT>
