...
function fnSave(isFileUploaded)
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.rivalpat.analysis.act.CreateAnalysisDoc.do";
...
function fnSearch_a()
{
    ...
    ds_mainInfo.value(0, "OUR_APPNO") = win.rtn.PAT_APP_NO;
    ds_mainInfo.value(0, "OUR_APPDATE") = win.rtn.APP_DATE;
    ds_mainInfo.value(0, "OUR_PUBNO") = win.rtn.PUB_NO;
    ds_mainInfo.value(0, "OUR_PUBDATE") = win.rtn.PUB_DATE;
    ds_mainInfo.value(0, "OUR_REGNO") = win.rtn.REG_NO;
    ds_mainInfo.value(0, "OUR_REGDATE") = win.rtn.REG_DATE;
...
function fnSearch_b()
{
    ...
    ds_mainInfo.value(0, "THEM_APPNO") = win.rtn.K_APP_NO;
    ds_mainInfo.value(0, "THEM_APPDATE") = win.rtn.APP_DATE;
    ds_mainInfo.value(0, "THEM_PUBNO") = win.rtn.PUB_NO;
    ds_mainInfo.value(0, "THEM_PUBDATE") = win.rtn.PUB_DATE;
    ds_mainInfo.value(0, "THEM_REGNO") = win.rtn.REG_NO;
    ds_mainInfo.value(0, "THEM_REGDATE") = win.rtn.REG_DATE;
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        ...
        <TD><INPUT Type="text" id="AN_TITLE" maxByte = "2000"  bind="ds_mainInfo"></TD>
        <TD req="THEM_NAME" >경쟁사</TD>
        <TD><INPUT Type="text" id="THEM_NAME" maxByte = "2000" bind="ds_mainInfo"></TD>
    </TR>
    <TR>
        <TD colspan="2" align="center">자사정보&nbsp; <ANY:SELECT id="OUR_RIGHT" codeData="{RIGHT_DIV}" firstName="=선택=" bind="ds_mainInfo"  style="width:70px;" onClick="javascript:ch_ourright(OUR_RIGHT.value,THEM_RIGHT.value);"/><BUTTON text="검색" onClick="javascript:fnSearch_a();"/></TD>
        <TD colspan="2" align="center">비교정보&nbsp; <ANY:SELECT id="THEM_RIGHT" codeData="{RIGHT_DIV}" firstName="=선택=" bind="ds_mainInfo"  style="width:90px;" onClick="javascript:ch_themright(THEM_RIGHT.value,OUR_RIGHT.value);"/><BUTTON text="검색" onClick="javascript:fnSearch_b();"/></TD>
    </TR>
    <TR>
        <TD>출원번호/출원일자</TD>
        <TD>
            <INPUT type="text" id="OUR_APPNO" maxByte = "20" bind="ds_mainInfo" style="width:120px;">/<ANY:DATE id="OUR_APPDATE"  bind="ds_mainInfo"/>
        </TD>
        <TD>출원번호/출원일자</TD>
        <TD>
            <INPUT type="text" id="THEM_APPNO" maxByte = "20" bind="ds_mainInfo" style="width:120px;">/<ANY:DATE id="THEM_APPDATE"  bind="ds_mainInfo"/>
        </TD>
    </TR>
    <TR>
        <TD>공개번호/공개일자</TD>
        <TD>
            <INPUT type="text" id="OUR_PUBNO" maxByte = "20" bind="ds_mainInfo" style="width:120px;">/<ANY:DATE id="OUR_PUBDATE"  bind="ds_mainInfo"/>
        </TD>
        <TD>공개번호/공개일자</TD>
        <TD>
            <INPUT type="text" id="THEM_PUBNO" maxByte = "20" bind="ds_mainInfo" style="width:120px;">/<ANY:DATE id="THEM_PUBDATE"  bind="ds_mainInfo"/>
        </TD>
    </TR>
    <TR>
        <TD>등록번호/등록일자</TD>
        <TD>
            <INPUT type="text" id="OUR_REGNO" maxByte = "20" bind="ds_mainInfo" style="width:120px;">/<ANY:DATE id="OUR_REGDATE"  bind="ds_mainInfo"/>
        </TD>
        <TD>등록번호/등록일자</TD>
        <TD>
            <INPUT type="text" id="THEM_REGNO" maxByte = "20" bind="ds_mainInfo" style="width:120px;">/<ANY:DATE id="THEM_REGDATE"  bind="ds_mainInfo"/>
        </TD>
    </TR>
    <TR id="item1" style="display:none;" >
        <TD><ANY:SPAN id="OUR_ITEM_TITLE" style="display:none;" >청구항(독립항)</ANY:SPAN></TD>
        <TD>
            <TEXTAREA id="OUR_ITEM" rows="5" bind="ds_mainInfo"  style="display:none;"></TEXTAREA>
        </TD>
        <TD><ANY:SPAN id="THEM_ITEM_TITLE" style="display:none;">청구항(독립항)</ANY:SPAN></TD>
        <TD>
            <TEXTAREA id="THEM_ITEM" rows="5" bind="ds_mainInfo" style="display:none;"></TEXTAREA>
        </TD>
    </TR>
    <TR>
        <TD><ANY:SPAN id="OUR_ATTACH1_TITLE" value="첨부파일"></ANY:SPAN></TD>
        <TD>
            <ANY:FILE id="any_analyFileId1" mode="C"  bind="ds_mainInfo:OUR_ATTACH1"  policy="design_image" imageMode="true" />
        </TD>
        <TD><ANY:SPAN id="THEM_ATTACH1_TITLE" value="첨부파일"></ANY:SPAN></TD>
        <TD>
            <ANY:FILE id="any_analyFileIdThem1" mode="C"  bind="ds_mainInfo:THEM_ATTACH1"  policy="design_image" imageMode="true" />
        </TD>
    </TR>
    <TR>
        <TD colspan="2" id="design_attach_our" style="display:none;" class="contdata" ><ANY:SPAN id="OUR_ATTACH2_TITLE" style="width:60px; display:none;">정면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileId2" mode="C"  bind="ds_mainInfo:OUR_ATTACH2" policy="design_image" imageMode="true"  style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="OUR_ATTACH3_TITLE"  style="width:60px; display:none;">배면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileId3" mode="C"  bind="ds_mainInfo:OUR_ATTACH3" policy="design_image" imageMode="true"  style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="OUR_ATTACH4_TITLE"  style="width:60px; display:none;">죄측면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileId4" mode="C"  bind="ds_mainInfo:OUR_ATTACH4" policy="design_image" imageMode="true"  style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="OUR_ATTACH5_TITLE"  style="width:60px; display:none;">우측면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileId5" mode="C"  bind="ds_mainInfo:OUR_ATTACH5" policy="design_image" imageMode="true"  style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="OUR_ATTACH6_TITLE"  style="width:60px; display:none;">평면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileId6" mode="C"  bind="ds_mainInfo:OUR_ATTACH6" policy="design_image" imageMode="true"  style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="OUR_ATTACH7_TITLE"  style="width:60px; display:none;">저면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileId7" mode="C"  bind="ds_mainInfo:OUR_ATTACH7" policy="design_image" imageMode="true"  style="width:320px; display:none;"/>
        </TD>
        <TD colspan="2" id="design_attach_them" style="display:none;" class="contdata" ><ANY:SPAN id="THEM_ATTACH2_TITLE"  style="width:60px; display:none;">정면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileIdThem2" mode="C" policy="design_image" imageMode="true"  bind="ds_mainInfo:THEM_ATTACH2" style="width:320px; display:none;"/><br>
                                <ANY:SPAN id="THEM_ATTACH3_TITLE"  style="width:60px; display:none;">배면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileIdThem3" mode="C" policy="design_image" imageMode="true"  bind="ds_mainInfo:THEM_ATTACH3" style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="THEM_ATTACH4_TITLE"  style="width:60px; display:none;">죄측면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileIdThem4" mode="C" policy="design_image" imageMode="true"  bind="ds_mainInfo:THEM_ATTACH4" style="width:320px; display:none;"/><br>
                                <ANY:SPAN id="THEM_ATTACH5_TITLE"  style="width:60px; display:none;">우측면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileIdThem5" mode="C" policy="design_image" imageMode="true"  bind="ds_mainInfo:THEM_ATTACH5" style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="THEM_ATTACH6_TITLE"  style="width:60px; display:none;">평면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileIdThem6" mode="C" policy="design_image" imageMode="true"  bind="ds_mainInfo:THEM_ATTACH6" style="width:320px; display:none;"/><br>
                                 <ANY:SPAN id="THEM_ATTACH7_TITLE"  style="width:60px; display:none;">저면도</ANY:SPAN>
            <ANY:FILE id="any_analyFileIdThem7" mode="C" policy="design_image" imageMode="true"  bind="ds_mainInfo:THEM_ATTACH7" style="width:320px; display:none;"/>
        </TD>
    </TR>
    <TR>
    ...
    <TR>
        <TD>검토의견</TD>
        <TD colspan="3">
            <TEXTAREA id="AN_OPINION" rows="5"   bind="ds_mainInfo" ></TEXTAREA>
        </TD>
    ...
    <TR>
        <TD>비고</TD>
        <TD colspan="3">
            <TEXTAREA id="AN_BIGO" rows="5"  bind="ds_mainInfo"></TEXTAREA>
        </TD>
    </TR>
    <TR>
        <TD>공개/미공개</TD>
        <TD colspan="3">
            <ANY:RADIO id="PUB_YN" codeData="{OPEN_YN}"  bind="ds_mainInfo"  style="width:40%"/>
        </TD>
    </TR>
    <TR>
        <TD>첨부파일</TD>
        <TD colspan="3">
            <ANY:FILE id="any_attachFile"  mode="C"  policy="paper"   bind="ds_mainInfo:ATTACH_FILE" />
        </TD>
    </TR>
</TABLE>
