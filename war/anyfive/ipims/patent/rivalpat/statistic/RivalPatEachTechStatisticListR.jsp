...
function fnRetrieveActualByTechList(priorCode)
{
    ...
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.statistic.statistic.act.RetrieveActualByTechList.do"; //자사
    ...
    ldr2.addParam("TECH_CODE" , techCode);
...
function fnRivalAppno(gr, fg, row, colId)
{
...
function fnRefno(gr, fg, row, colId)
{
    ...
    if(gr.value(row,"INOUT_DIV") == "INT"){
        win.path = "RetrieveIntPatentMasterRD.jsp";//국내마스터
    }else{
        win.path = "RetrieveIntExPatentMasterRD.jsp";//해외마스터
    }
...
function fnActualAppNo(gr, fg, row, colId)
{
                            ...
                            <TR>
                                <TD>
                                    <ANY:GRID id="gr_actualByTechList" pagingType="1"><COMMENT>
                                        ...
                                        addColumn({ width:180, align:"left"  , type:"string" , sort:false, id:"KO_APP_TITLE"      , name:"발명의 명칭(한)" });
                                        addColumn({ width:180, align:"left"  , type:"string" , sort:false, id:"EN_APP_TITLE"      , name:"발명의 명칭(영)" });
                                        addColumn({ width:75 , align:"center", type:"date"   , sort:false, id:"APP_DATE"          , name:"출원일" });
                                        addColumn({ width:120, align:"left"  , type:"string" , sort:false, id:"APP_NO"            , name:"출원번호" });
                                        addColumn({ width:75 , align:"center", type:"date"   , sort:false, id:"REG_DATE"          , name:"등록일" });
                                        addColumn({ width:120, align:"string", type:"string" , sort:false, id:"REG_NO"            , name:"등록번호" });
                                        addColumn({ width:120, align:"string", type:"string" , sort:false, id:"PJT_NAME"            , name:"대표PJT" });
                                        addColumn({ width:120, align:"string", type:"string" , sort:false, id:"OFFICE_NAME"            , name:"국내사무소" });
                                        addColumn({ width:200, align:"string", type:"string" , sort:false, id:"INVENTOR_NAMES"            , name:"발명자" });
                                        ...
                                        addAction("APP_NO", fnActualAppNo);
                                    </COMMENT></ANY:GRID>
                                </TD>
                            </TR>
                        </TABLE>
