...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.boardmgt.act.CreateBoardMgt.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD req="SYSTEM_TYPE,MENU_CODE">게시판 메뉴</TD>
        <TD>
            <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
                <TR>
                    <TD width="70px">
                        <ANY:SELECT id="SYSTEM_TYPE" codeData="{SYSTEM_TYPE}" value="PATENT" />
                    </TD>
                    <TD style="padding-left:3px;">
                        <ANY:SEARCH id="MENU_CODE" mode="C"><COMMENT>
                            win.path = top.getRoot() + "/anyfive/ipims/patent/common/popup/search/MenuCodeSearchTreeR.jsp";
                            win.arg.SYSTEM_TYPE = "PATENT";
