...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.papermgt.paperwf.act.CreatePaperWFPaper.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>세부서류</TD>
        <TD>
            <ANY:SELECT id="PAPER_SUBCODE" firstName="all" />
        </TD>
    </TR>
</TABLE>
