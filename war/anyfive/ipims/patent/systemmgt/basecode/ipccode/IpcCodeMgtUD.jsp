...
<HTML XMLNS:ANY>
<HEAD>
<TITLE>IPC분류코드 수정</TITLE>
<% app.writeHTMLHeader(); %>
<ANY:DS id="ds_mainInfo"><COMMENT>
    addBind("IPC_CODE");
    addBind("PRIOR_IPC_CODE");
    addBind("IPC_HNAME");
    addBind("IPC_DESC");
    addBind("USE_YN");
</COMMENT></ANY:DS>
...
{
    IPC_CODE.value = parent.IPC_CODE;
...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.ipccode.act.RetrieveIpcCode.do";
    prx.addParam("IPC_CODE", parent.IPC_CODE);
...
function fnSave()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.ipccode.act.UpdateIpcCode.do";
    prx.addParam("IPC_CODE", parent.IPC_CODE);
...
function fnDelete()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.ipccode.act.DeleteIpcCode.do";
    prx.addParam("IPC_CODE", parent.IPC_CODE);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>IPC분류 코드</TD>
        <TD>
            <INPUT type="text" id="IPC_CODE" readOnly style="border:none;">
        </TD>
    </TR>
    <TR>
        <TD>상위IPC분류 코드</TD>
        <TD>
            <INPUT type="text" id="PRIOR_IPC_CODE" readOnly style="border:none;">
        </TD>
    </TR>
    <TR>
