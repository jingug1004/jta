...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.apprmgt.act.RetrieveApprCodeMgt.do";
    prx.addParam("APPR_CODE", parent.APPR_CODE);
...
function fnSave()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.apprmgt.act.UpdateApprCodeMgt.do";
    prx.addParam("APPR_CODE", parent.APPR_CODE);
...
function fnDelete()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.apprmgt.act.DeleteApprCodeMgt.do";
    prx.addParam("APPR_CODE", parent.APPR_CODE);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>결재코드</TD>
        <TD>
            <INPUT type="text" id="APPR_CODE" readOnly style="border:none;">
        </TD>
    </TR>
    <TR>
