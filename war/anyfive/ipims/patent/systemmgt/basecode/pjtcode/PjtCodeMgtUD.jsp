...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.pjtcode.act.RetrievePjtCode.do";
    prx.addParam("PJT_CODE", parent.PJT_CODE);
...
function fnSave()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.pjtcode.act.UpdatePjtCode.do";
    prx.addParam("PJT_CODE", parent.PJT_CODE);
...
function fnDelete()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.basecode.pjtcode.act.DeletePjtCode.do";
    prx.addParam("PJT_CODE", parent.PJT_CODE);
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD>프로젝트코드</TD>
        <TD colspan="3"><SPAN id="PJT_CODE"></SPAN></TD>
    </TR>
    <TR>
