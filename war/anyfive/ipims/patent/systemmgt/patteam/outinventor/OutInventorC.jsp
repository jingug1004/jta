...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.patteam.outinventor.act.CreateOutInventor.do";
    ...
    prx.onSuccess = function()
    {
        ...
        window.location.replace("OutInventorUD.jsp");
    }
