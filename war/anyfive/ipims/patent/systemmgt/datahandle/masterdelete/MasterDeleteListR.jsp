...
<HTML XMLNS:ANY>
<HEAD>
<TITLE>출원마스터 삭제</TITLE>
<% app.writeHTMLHeader(); %>
<% app.writeHTCImport(app.HTC_GRID); %>
<ANY:DS id="ds_masterDeleteList" />
...
function fnRetrieve()
{
    var ldr = gr_masterDeleteList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.datahandle.masterdelete.act.RetrieveMasterDeleteList.do";
    ldr.addParam("RIGHT_DIV", RIGHT_DIV.value);
    ldr.addParam("REF_NO", REF_NO.value);
    ldr.addParam("APP_TITLE", APP_TITLE.value);
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_masterDeleteList" pagingType="1"><COMMENT>
