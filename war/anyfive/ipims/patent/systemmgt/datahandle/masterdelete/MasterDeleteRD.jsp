...
function fnRetrieve()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.datahandle.masterdelete.act.RetrieveMasterDelete.do";
...
function fnDetail()
{
    ...
    switch (ds_mainInfo.value(0, "INOUT_DIV")) {
    case "INT":
...
function fnDelete()
{
    ...
    var prx = new any.proxy();
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.datahandle.masterdelete.act.DeleteMaster.do";
    prx.addParam("REF_ID", parent.REF_ID);
