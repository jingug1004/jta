...
<HTML XMLNS:ANY>
<HEAD>
<TITLE>자산거절결제 취소</TITLE>
<% app.writeHTMLHeader(); %>
<% app.writeHTCImport(app.HTC_GRID); %>
<ANY:DS id="ds_assetCancleList" />
...
function fnRetrieve()
{
    var ldr = gr_assetCancleList.loader;

    ldr.init();
    ldr.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.datahandle.assetappcancle.act.RetrieveAssetCancleList.do";
...
{
    var gr = gr_assetCancleList;
    var ds = ds_assetCancleList;
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.datahandle.assetappcancle.act.AssetCancleListU.do";
    prx.addData(ds);
    prx.onSuccess = function()
    {
        alert("<%= app.message.get("msg.com.info.cancle").toJS() %>");
        fnRetrieve();
    }
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    ...
    <TR>
        <TD height="100%">
            <ANY:GRID id="gr_assetCancleList" pagingType="1"><COMMENT>
