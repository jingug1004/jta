...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.evalsheet.evalcode.act.CreateEvalCodeMgt.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        <TD req="EVAL_CODE">평가 코드</TD>
        <TD>
            <INPUT type="text" id="EVAL_CODE" maxByte="3" style="text-transform:uppercase;">
        </TD>
    </TR>
    <TR>
