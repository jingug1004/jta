...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.evalsheet.evalsheet.act.CreateEvalSheetMgt.do";
    prx.addData("ds_mainInfo");

    prx.onSuccess = function()
    {
        parent.EVAL_SHEET_ID = this.result;
        alert("<%= app.message.get("msg.com.info.save").toJS() %>");
        window.location.replace("EvalSheetUD.jsp");
    }
