...
function fnSave()
{
    ...
    prx.path = top.getRoot() + "/anyfive.ipims.patent.systemmgt.workprocess.workmst.act.CreateWorkMstMgt.do";
...
<TABLE border="0" cellspacing="1" cellpadding="2" class="main">
    ...
    <TR>
        ...
        <TD>
            <INPUT type="text" id="BIZ_MGT_ID" maxByte="3" style="text-transform:uppercase;">
        </TD>
    </TR>
    <TR>
